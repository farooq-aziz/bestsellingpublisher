...
// images
import bookbadges8 from 'media/images/bookbadges/8.png'
import bookbadges1 from 'media/images/bookbadges/1.png'
            ...
            <div className={styles.bookbadges}>
                ...
                <Container className='bookalign'>
                    <Row className={` ${styles.bookrow} gy-3 `}>
                        ...
                        <Col md={12}>
                            <h1 className='font50 fw700 color-blue text-center mb-5 font-secondary'>Children's Book Illustrations</h1>
                        </Col>
