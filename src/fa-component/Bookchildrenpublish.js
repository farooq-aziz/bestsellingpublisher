...
// images
import bookbadges6 from 'media/images/bookbadges/6.png'
import bookbadges7 from 'media/images/bookbadges/7.png'
            ...
            <div className={styles.bookbadges}>
                ...
                <Container className='bookalign'>
                    <Row className={` ${styles.bookrow} gy-3 `}>
                        ...
                        <Col md={12}>
                            <h2 className='font50 fw700 color-blue text-center mb-5 font-secondary'>Children Book Publication</h2>
                        </Col>
