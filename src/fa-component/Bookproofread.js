...
// images
import bookbadges2 from 'media/images/bookbadges/2.png'
import bookbadges3 from 'media/images/bookbadges/3.png'
            ...
            <div className={styles.bookbadges}>
                ...
                <Container className='bookalign'>
                    <Row className={` ${styles.bookrow} gy-3 `}>
                        ...
                        <Col md={12}>
                            <h2 className='font50 fw700 color-blue text-center mb-5 font-secondary'>Book Proofreading</h2>
                        </Col>
